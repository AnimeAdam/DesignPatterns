//The Facade Pattern seeks to provide a unified interface to a complex system. 
//It is same as Facade in building architecture, a Facade is an object that serves 
//as a front-facing interface masking a more complex underlying system.
