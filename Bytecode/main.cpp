//The Bytecode pattern is pretty simple, it's an interpretor but with byte flags
//And it also uses the concept of a register with pop and push to optimise the code.

//Below is some example code from Game Programming Patterns
#include <assert.h>
