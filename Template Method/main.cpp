//The template method is using a standardised execute for a group of functions
//that need execute but are abstruct to allow for changes in the subclassees.
#include <iostream>
