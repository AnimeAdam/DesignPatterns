//The Subclass Sandbox pattern Is basically a super class with abstract interface that activates other components.

//Below are a couple of examples of the Subclass Sandbox.
typedef int SoundId;
